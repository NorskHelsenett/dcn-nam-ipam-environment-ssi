/**
 * Logger Configuration - Winston-based logging system for NAM-IPAM-ENVIRONMENT-SSI
...
logger.on("error", (error: Error) => {
  logger.warning(`nam-ipam-environment-ssi: Error in logger ${error.message}`, {
    component: "logger",
...
const addHecLogger = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on WinstonHecLogger,  ${
...
export const removeHecLogger = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on removeHecLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const addFileLoggers = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on FileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const removeFileLoggers = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on removeFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const addSplunkFileLogger = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on SplunkFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const removeSplunkFileLogger = () => {
  try {
    ...
    logger.error(
      `nam-ipam-environment-ssi: Error on removeSplunkFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
logger.debug(
  `nam-ipam-environment-ssi: Logger initialized at ${logLevel()} level`,
);
